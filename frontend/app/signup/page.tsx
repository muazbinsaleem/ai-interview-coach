        ...
        <div className="bg-[var(--bg-surface)] border border-[var(--border)] rounded-2xl shadow-xl overflow-hidden">
          <div className="p-8">
            <div className="mb-6 text-center">
              ...
              <p className="text-sm text-[var(--text-secondary)] mt-1">Start practising for free today</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1.5">
                <label htmlFor="name" className="text-sm font-medium text-[var(--text-primary)]">Full name</label>
                <div className="relative">
                  <RiUserLine className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[var(--text-muted)]" />
                  <input
                    id="name"
                    type="text"
                    required
          ...
          <div className="px-8 py-4 bg-[var(--bg-base)] border-t border-[var(--border)] text-center">
            <p className="text-sm text-[var(--text-secondary)]">
              ...
              <Link href="/login" className="text-[#60a5fa] hover:text-[#2563EB] font-medium transition-colors">
                Sign in
              </Link>
            </p>
          </div>
